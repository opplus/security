...
(function($){
	flux.slider = function(elem, opts) {
		...
		this.image1 = $('<div class="image1" style="height: 300px; width: 500px"></div>').appendTo(this.imageContainer);
		this.image2 = $('<div class="image2" style="height: 300px; width: 500px"></div>').appendTo(this.imageContainer);
				...
				setTimeout(function(){
					blocks.each(function(index, block){				
						$(block).css({
							...
							'transform': flux.browser.translate(0, 0, 500) + " rotate3d("+(Math.round(Math.random()*2)-1)+", "+(Math.round(Math.random()*2)-1)+", "+(Math.round(Math.random()*2)-1)+", 90deg) "
						});
					});
				}, 50);
			}
