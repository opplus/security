...
<head>
    ...
    <script>
        ...
        function sendnews() {
            var str11 = '<label>新闻类型</label>';
            var str12 = '<select id="newstype" name="newstype"><option vlaue="in">国内新闻</option><option vlaue="out">国外新闻</option></select>';
            var str21 = '<label>标题</label>';
            var str22 = '<input type="text" id="title" name="title">';
            var str31 = '<label>正文</label>';
            var str41 = '<label>原文链接</label>';
            var str42 = '<input type="text" id="newsurl" name="url"><hr>';
            var str61 = '<input type="button" value="提交" onclick="javascript:sends(\'' + 'news' + '\')">';
...
//                            alert(data.image);
        ...
        function sends(newsclass) {
                var title = $("#title").val();
                var type = $("#newstype  option:selected").text();
                var url = $("#newsurl").val();
                ...
                $.ajax({
                    ...
                    type: "post",
                    datatype: "json",
                    data: {newstype: type, title: title, content: newscontent, newsurl: url},
